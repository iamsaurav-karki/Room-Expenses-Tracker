...
const Dashboard = () => {
  ...
  useEffect(() => {
    console.log("[v0] Dashboard - currentRoomId:", currentRoomId)
    if (currentRoomId) {
      loadDashboard()
    }
  ...
  const loadDashboard = async () => {
    try {
      setLoading(true)
      setError(null)
      console.log("[v0] Dashboard - Loading dashboard data...")
      ...
      console.error("[v0] Dashboard - Error loading data:", err)
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <StatCard
          ...
          color="green"
        />
        <StatCard title="Roommates" value={stats.totalRoommates} subtitle="Active members" icon="👥" color="purple" />
        <StatCard
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {members.map((member) => (
              ...
              >
                ...
                {member.nickname && <div className="text-sm text-gray-500 mt-1">@{member.nickname}</div>}
              </div>
            ))}
          </div>
        )}
